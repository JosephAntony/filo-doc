(function(name, module, context){
	...
	if(window.define)
		...
		context.patientDetails =  module(context.validator);

})('patientDetails', function(validatorObj){
		...
		,eventObj:{
			handleEvent: function(event){
					...
					switch(event.target.id){
						...
						case "addMedicines":              	 
									   var addMedicinesOverlay = document.getElementById("addMedicinesOverlay");
									   addMedicinesOverlay.style.visibility="visible";
									   break;

						case "addAppliances":
									   var addAppliancesOverlay = document.getElementById("addAppliancesOverlay");
									   addAppliancesOverlay.style.visibility="visible";
									   break;					   		
